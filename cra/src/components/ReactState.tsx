...
export default class ReactState extends Component<props, { stateString: string, stateNumber: number }>{
  ...
  render() {
    ...
    return (
      <div>
        ...
        <button onClick={(e) => { this.stateChange("direct") }}>State 직접 변경</button>
        <button onClick={e => { this.stateChange("setState") }}>SetState로 변경</button>
        <button onClick={e => { this.stateChange("forceupdate") }}>State 강제 업데이트</button>
